	...
	<div class="container">
		...
		<sf:form
			...
			<div class="form-group">
				...
				<sf:input path="ScheduleInfo.Cinema.CineInfo.cinemaName"
					id="cinema_name" class="form-control" />
				<sf:errors path="ScheduleInfo.Cinema.CineInfo.cinemaName"
			...
			<div class="form-group">
				...
				<sf:input path="ScheduleInfo.Cinema.CineInfo.roomName"
					id="room_name" class="form-control" />
				<sf:errors path="ScheduleInfo.Cinema.CineInfo.roomName"
					cssStyle="color:#ff0000;" />
			</div>

			<div class="form-group">
				<label for="movieName" style="font-weight: bold">영화 제목</label>
				<sf:input path="Movie.movieName" id="movie_name"
					class="form-control" />
			...
			<div class="form-group">
				...
				<sf:input path="ScheduleInfo.startTime" id="start_time"
					class="form-control" />
